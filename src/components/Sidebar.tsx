...
function Sidebar() {
    const {productStates, closeSidebar} = useProductsContext();
    const { isSidebarOpen } = productStates;
    const { CartInitialState } = useCartContext();
    const { total_items } = CartInitialState
